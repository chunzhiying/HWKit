...
- (HWAnimation *(^)(CGFloat, CGFloat, CGFloat, CGFloat))scaleBounce {
    return ^(CGFloat start, CGFloat middle, CGFloat end, CGFloat duration) {
        ...
        .animationGroup.fillMode(HW_FillMode_Retain).duration(2 * duration);
    };
}
