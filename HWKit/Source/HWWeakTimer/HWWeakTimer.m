...
{
    return [self scheduledTimerWithTimeInterval:interval target:aTarget selector:aSelector userInfo:userInfo repeats:repeats callBack:nil];
}
...
{
    return [self timerWithTimeInterval:ti target:aTarget selector:aSelector userInfo:userInfo repeats:yesOrNo runloop:runloop mode:mode callBack:nil];
}
...
{
    return [self scheduledTimerWithTimeInterval:interval target:aTarget selector:nil userInfo:userInfo repeats:repeats callBack:block];
}
...
+ (nonnull NSTimer *)timerWithTimeInterval:(NSTimeInterval)ti
                                  ...
                                  callBack:(nonnull TimerBlock)block
{
    return [self timerWithTimeInterval:ti target:aTarget selector:nil userInfo:userInfo repeats:yesOrNo runloop:runloop mode:mode callBack:block];
}
